...
function clicked(){
	...
	dColor = "red";
	speed_up_dict = {};
	//	let arr = ['aattttcctt','attaggccgc','aagggccttc','atagttttag','cgatttggga','aacttcatca','tcacttaaag','agttgcgata','accgatgaag','tcggaaacaa','tacggaattt','cttggtaaac','tcagcaacca','ttttatcact','gttttttgaa','gcattatttg','ataatacatc','acggattgtg','tcaaccgata','caccttgcca','atcagccaat','tcctgttggg','tgtaattacc','taatattgta']
